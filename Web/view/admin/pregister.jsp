				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="index.html">Home</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-black">Product Register</strong>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div>
					...
					<div class="col-md-7" style="margin: 0 auto">
						<h2 style="margin: 0 auto;">Product Register</h2>
						<form enctype="multipart/form-data" action="pregister.mc"
							...
							<div class="p-3 p-lg-5 border">
								...
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_subject" class="text-black">Category </label> 
