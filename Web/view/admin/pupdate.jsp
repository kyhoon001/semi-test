				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="index.html">Home</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-black">Product Update</strong>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div>
					...
					<div class="col-md-7" style="margin: 0 auto">
						<h2 style="margin: 0 auto;">Product Update</h2>
						<form enctype="multipart/form-data" action="pupdate.mc"
							method="post" id="inform">

							<div class="p-3 p-lg-5 border">
								<div class="form-group row">
									<div class="col-md-6">
										<input type="hidden" class="form-control" id="c_fname"
											name="product_id" value="${dbproduct.product_id}"> <input
											type="hidden" class="form-control" id="c_fname"
											name="category_id" value="${dbproduct.category_id}"> <label
											for="c_fname" class="text-black">Name <span
											class="text-danger">*</span></label> <input type="text"
											class="form-control" id="c_fname" name="name"
											value="${dbproduct.name}">
									</div>
									<div class="col-md-6">
										<label for="c_lname" class="text-black">Price<span
											class="text-danger">*</span></label> <input type="text"
											class="form-control" id="c_lname" name="price"
								...
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_email" class="text-black">Image <span
											...
											class="form-control" id="c_email" name="mf" placeholder=""
											value="${dbproduct.img}">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_subject" class="text-black">Stock </label> <input
											type="text" class="form-control" id="c_subject" name="stock"
											value="${dbproduct.stock}">
									</div>
								</div>

								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_message" class="text-black">Description
										</label>
										<textarea name="description" id="c_message" form="inform"
											cols="30" rows="7" class="form-control">${dbproduct.description }</textarea>
									</div>
								</div>
								<div class="form-group row">
									<div class="col-lg-12">
